...
const alphabetizeBetter = (arr) => {
  ...
  arr.sort((a, b) => {
    for (let i = 0; i < a.length; i++) {
      if (a.toUpperCase()[i] === b.toUpperCase()[i]) {
        continue;
      } else {
        return a.toUpperCase().charCodeAt(i) - b.toUpperCase().charCodeAt(i);
      }
    }
  });
  return arr;
...
const sortPeople = (arr) => {
  // Solution code here...
  arr.sort((a, b) => a.lastName.charCodeAt(0) - b.lastName.charCodeAt(0));
  return arr;
};
